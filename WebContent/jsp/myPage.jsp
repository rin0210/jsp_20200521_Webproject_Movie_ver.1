            ...
            <div class="container">
                <div class="row justify-content-center mypage-space">
                    <div class="col-md-1010">
                        <div class="row model-detail d-mf-flex align-items-center align-items-center-up">
                            <div class="col-md-6 ftco-animate">
                                <div class="carousel-model owl-carousel">
                                    <div class="items">
                                        <img src="images/profile_1.jpg" width="450px" height="450px" class="img-fluid-profile" alt="Colorlib Template">
                                    </div>
                            ...
                            <div class="col-md-5 model-info ftco-animate">
                                <h3 class="mb-4">뚜뚜</h3>
                                <a href="#" class="btn btn-primary py-3 px-4 btn-page">프로필 수정</a>
                                <a href="#" class="btn btn-primary py-3 px-4 btn-page">이용권 구매</a>
                            </div>
                        </div>
