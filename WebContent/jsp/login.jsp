		...
		<div class="login-box">
			<div class="login member-layout">
				...
				<div class="join-sns-box">
					<form name="loginForm" action="MainServlet?command=Movie_Login" method="post">
                ...
                <li class="check-style check-style-dark"><input type="checkbox" id="login-auto"
					...
					<div class="div_join-find">
						<ul class="join-find">
							<!--<li><a href="https://member.wavve.com/find/id">아이디 찾기</a></li>
            <li><a href="https://member.wavve.com/find/password">비밀번호 재설정</a></li>-->

							<li>&ensp;&nbsp;회원이 아니신가요?<a
								href="MainServlet?command=Movie_JoinForm">지금 가입하세요.</a></li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="col-md-2">
				<div class="ftco-footer-widget">
					...
					<ul class="list-unstyled-login">
						<li><a href="MainServlet?command=Movie_home"
